...
import { idlFactory } from './manual_firts_project.did.js';
export { idlFactory } from './manual_firts_project.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MANUAL_FIRTS_PROJECT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./manual_firts_project.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the manual_firts_project canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./manual_firts_project.did.js")._SERVICE>}
 */
export const manual_firts_project = createActor(canisterId);
